...
import type { Exercise, ExerciseWithCategory } from "@/lib/types"
...
export const SelectExercise = React.memo(
  ({ exercises, exerciseId, onExerciseChange }: SelectExerciseProps) => {
    return (
      <Select name="exercice" value={exerciseId} onValueChange={onExerciseChange}>
