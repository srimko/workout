...
export function DrawerExercise() {
  ...
  const steps = [
    {
      ...
      props: { weight: formData.weight, onSelectExercise: handleExerciseChange },
      fieldKey: 'exercise',
    ...
    },
    {
      ...
      props: { repetition: formData.repetition, onRepetitionChange: handleRepetionChange },
      fieldKey: 'repetition',
  ...
  function handleRepetionChange(repetition: number) {
    ...
    if (repetition) {
      ...
      display += display ? ` en ${repetition} ${repetitionPlural}` : `${repetition} ${repetitionPlural}`;
    }
      ...
      <DrawerContent>
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader>
            ...
            <DrawerDescription>
                { formatExerciseDisplay(formData) }
            </DrawerDescription>
          </DrawerHeader>
          ...
          <DrawerFooter className="mb-12">
            ...
            >Précédent</Button>
                ...
                >
                    {step === steps.length - 1 ? (
                    isLoading ? "Enregistrement..." : "Envoyer"
                    ) : (
                    "Suivant"
                    )}
                </Button>
